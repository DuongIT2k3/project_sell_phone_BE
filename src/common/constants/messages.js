...
const MESSAGES = {
	...
	USER: {
		...
		ACTIVATE_SUCCESS: "Kích hoạt người dùng thành công",
		DEACTIVATE_SUCCESS: "Vô hiệu hóa người dùng thành công",
		...
		CANNOT_DEACTIVATE_SUPER_ADMIN: "Không thể vô hiệu hóa Super Admin",
	...
	NEWS: {
		...
		GET_BY_SLUG_SUCCESS: "Lấy chi tiết tin tức thành công",
		GET_RELATED_SUCCESS: "Lấy tin tức liên quan thành công",
		CREATE_SUCCESS: "Tạo tin tức thành công",
		UPDATE_SUCCESS: "Cập nhật tin tức thành công",
		DELETE_SUCCESS: "Xóa tin tức thành công",
		RESTORE_SUCCESS: "Khôi phục tin tức thành công",
		PUBLISH_SUCCESS: "Xuất bản tin tức thành công",
		UNPUBLISH_SUCCESS: "Hủy xuất bản tin tức thành công",

		CREATE_ERROR: "Lỗi khi tạo tin tức",
		UPDATE_ERROR: "Lỗi khi cập nhật tin tức",
		DELETE_ERROR: "Lỗi khi xóa tin tức",
		RESTORE_FAILED: "Khôi phục tin tức thất bại",
		NOT_FOUND: "Không tìm thấy tin tức",
		INVALID_ID: "ID tin tức không hợp lệ",
		SLUG_EXISTS: "Slug đã tồn tại",
		MISSING_FIELDS: "Thiếu các trường bắt buộc",
		UNAUTHORIZED_AUTHOR: "Bạn không có quyền chỉnh sửa tin tức này",
	},
	...
	ORDER: {
		...
		WEBHOOK_SUCCESS: "Xử lý webhook thành công",
		...
		MISSING_FIELDS: "Thiếu các trường bắt buộc",
		MISSING_ORDER_CODE: "Thiếu mã đơn hàng",
		...
		INVALID_WEBHOOK_DATA: "Dữ liệu webhook không hợp lệ",
	},
